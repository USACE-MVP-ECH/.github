...
The purpose of this organization is to house scripts that are useful to the USACE St. Paul District H&H branch. This will enable collaboration, communication, and documentation for scripts throughout the branch. Please reach out to site owners (Lauren Allin or Mitch Weier) if unsure of where to put a script or if you have any questions. 
...
**New Members** Reach out to Lauren Allin or Mitch Weier to request access or new repositories or if you would like to help manage the repo.
